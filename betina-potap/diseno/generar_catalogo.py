...
y = para("Llevamos comida saludable y artesanal a tu oficina. Una sola compra que incluye a todos "
         "—celíacos, veganos, diabéticos y a quienes entrenan. Nada industrial, nada en serie: "
...
for i, (a, b) in enumerate(pills):
    x = 56 + i * (bw + 20); rrect(x, y - 110, bw, 100, 10, CARD); leaf(x + bw / 2 - 9, y - 34, 18, 6, 90, TEAL)
