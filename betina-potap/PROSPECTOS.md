# Lista de prospectos B2B — Betina Potap

> Primera tanda de potenciales clientes en zona de entrega (CABA + Z. Norte hasta
> Don Torcuato). Skill `prospecting`. Última actualización: 2026-06-23.
> ⚠️ Los datos de contacto exactos (mail/teléfono) hay que sacarlos de la web de
> cada uno antes de escribir. Acá está el QUÉ y el POR QUÉ; el contacto se completa.

## Estrategia: empezar por los que concentran muchas empresas

La forma más rápida de conseguir varios clientes de una es atacar lugares donde hay
**muchas startups juntas**: coworkings y aceleradoras. Un acuerdo = decenas de empresas.

---

## 🔥 Prioridad 1 — Coworkings (un deal = muchas empresas)
Ofrecerles: snacking saludable para el espacio común y/o ser el proveedor "healthy"
recomendado para las empresas que alojan. También coffee breaks para sus eventos.

| Coworking | Zona | Por qué | Cómo contactar |
|-----------|------|---------|----------------|
| **La Maquinita** | Palermo Soho, Palermo Hollywood, Villa Crespo, Núñez | Varias sedes, muchas startups | Web lamaquinita.co / IG |
| **AreaTres** | Palermo Soho | Premium, público fit/healthy | Web areatres.com |
| **Manawa Coworking** | Palermo Soho (Nicaragua 4817) | Creativo, emprendedores/startups | manawacoworking.com |
| **Working & Co** | Palermo, Villa Crespo, Belgrano (7 sedes) | Muchas oficinas | workingand.co |
| **Belephant** | Núñez y Belgrano (Av. Libertador 6680 / 6343) | Zona norte, cerca tuyo | belephant.co |
| **Ronda Coworking** | Belgrano (Ciudad de la Paz 1042) y Recoleta | Cercano | rondacoworking.com |
| **WeWork** | Palermo (Libertador 1000) y otras | Marca grande, muchos equipos | wework.com |
| **Spaces / Regus** | Microcentro, Palermo | Muchas empresas | spacesworks.com |

## 🔥 Prioridad 2 — Aceleradoras / hubs (acceso a muchas startups + eventos)
| Lugar | Zona | Por qué |
|-------|------|---------|
| **Wayra (Telefónica)** | Costa Rica 5546, Palermo Hollywood | Acelera startups; hacen eventos (coffee/catering) |
| **Polo IT Buenos Aires** | CABA | Asociación que nuclea empresas IT; eventos y contactos |
| **Polo DOT** | Saavedra | Hub de tech/startups (zona norte cercana) |

## 🟡 Prioridad 3 — Productoras (Distrito Audiovisual: Chacarita/Colegiales/Palermo)
El Distrito Audiovisual (Chacarita, Villa Ortúzar, Paternal, Palermo, **Colegiales**)
concentra ~189 productoras **a metros de tu zona**. Rodajes y oficinas = mucho catering/snack.
- **Cómo armar la lista:** Directorio Argentina Creativa, Buenos Aires Film Commission
  (bafc.buenosaires.gob.ar/guia-audiovisual/productoras) y el dataset de empresas
  audiovisuales del Gob. Ciudad.
- Nombres detectados para investigar: **Nítido Productora**, **Primo Audiovisual**.
- Ángulo: catering de rodaje saludable + snacking para la oficina.

## 🟡 Prioridad 4 — Estudios de abogados (oficinas estables, buen poder adquisitivo)
Zona Palermo / Barrio Norte / Belgrano / Recoleta. Suelen tener oficina fija, reuniones
con clientes (coffee break) y dan regalos corporativos.
- **Cómo armar la lista:** directorios legal.com.ar (26 estudios en Palermo, 13 en
  Belgrano), buscoabogado.aarg.ar (58 en Palermo), abogados.com.ar/directorio.
- Ángulo: coffee break para reuniones con clientes + regalo corporativo a clientes.

---

## Cómo trabajar esta lista (paso a paso para Betina)
1. **Arrancar por coworkings (Prioridad 1):** son 8, todos cercanos. Mandar el DM/mail
   de `OUTREACH.md` ofreciendo muestra gratis para el espacio común.
2. **Sumar productoras del Distrito Audiovisual** (está pegado a Colegiales): entrar
   a los directorios y anotar 15-20 con su web/IG.
3. **Después estudios de abogados** desde los directorios legales.
4. Cargar todo en una planilla simple:

```
Empresa | Categoría | Zona | Web/IG | Contacto | Estado | Notas
```

## Próximo paso que puedo hacer yo
- Entrar a los directorios públicos y armar una **planilla con 25-30 empresas
  concretas con nombre, zona y link** (lista lista para empezar a contactar).
- ¿La armo como CSV/planilla descargable?
...
[Directorio Argentina Creativa](https://www.cancilleria.gob.ar/es/directorios-argentina-creativa/productoras-audiovisuales) ·
[BA Film Commission](https://bafc.buenosaires.gob.ar/guia-audiovisual/productoras) ·
[Directorio abogados](https://www.legal.com.ar/abogados/estudios-juridicos/palermo-buenos-aires) ·
[Wayra](https://www.argentina.gob.ar/produccion/financiamiento/perfiles-de-aceleradoras) ·
